...
export function SettingsView({ profile }: { profile: UserProfile }) {
  ...
  if (!church) return (
    <div className="p-8 text-center">
      ...
      <button onClick={() => window.location.reload()} className="bg-church-primary text-white px-6 py-2 rounded-full">
        Tentar Novamente
      </button>
    </div>
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-stone-400 italic">Este ícone aparecerá no atalho do celular quando os membros instalarem o app. Você pode usar um emoji ou URL de imagem.</p>
              </div>
              <div className="space-y-2">
